...
-- Get the Most Expensive Product and Least Expensive Prothe duct
...
--Show Sales by categories for the year 1997 ONLY 
...
--For each category, get the list of products sold and the total amount per product
SELECT c.category_name, 
	   p.product_name,
		SUM (od.Quantity*od.Unit_price*(1-od.discount)) Total_Sales
FROM order_details od
